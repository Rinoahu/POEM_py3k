...
POEM will create a directory named filename.fasta_output to save the results. The results include serveral files:
    ...
    2.  input.fsa_gmk_aa.fsa:
        The fasta file of protein sequence and gff file generated by prediction of MetaGeneMark on input.fsa from step 1. If Metagenemark is used to predict the gene, there will be an additional file named input.fsa.gff in the directory.
